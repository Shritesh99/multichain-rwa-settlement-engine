...
const sepoliaTestnetContract: OmniPointHardhat = {
    eid: EndpointId.SEPOLIA_V2_TESTNET,
    contractName: 'RWASettlerONFT',
}
...
const pathways: TwoWayConfig[] = [
    [
        hederatTestnetContract, // Chain A contract
        sepoliaTestnetContract, // Chain B contract
...
export default async function () {
    ...
    return {
        contracts: [{ contract: hederatTestnetContract }, { contract: sepoliaTestnetContract }],
        connections,
    }
}
